 ...
 */
public class FieldFootPrintPanel extends JPanel implements Observer {
    private Graphics g;
    private Field field = null;
    public FieldFootPrintPanel() {
    }
    ...
    public void update(Observable o, Object arg) {
              System.out.println("Dans le field Foot");
        this.field = ControllerFootPrint.get_instance().getField();
    }
}
